  ...
  return (
    ...
    <div className="d-flex justify-content-center">
      <form onSubmit={submitHandler} className="d-flex flex-column align-items-center bg-light text-dark p-3 border rounded-3">
        ...
        <div className="mb-3">
          <input onChange={changeHandler} value={userSignIn.phone} className="form-control" type="text" name="phone" placeholder='Телефон' />
        </div>

        <div className="mb-3">
          <input onChange={changeHandler} value={userSignIn.password} className="form-control" type="password" name="password" placeholder='Пароль' />
        </div>
